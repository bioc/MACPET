...
\subsection{GetSortestPath methods}
\textcolor{LimeGreen}{\Rclass{GenomeMap}} 
class has a method which finds the length of the  sortest path between two user-specified peaks. Currently it only finds the sortest paths between intra-chromosomal peaks. Therefore, the peaks have to be on the same chromosome.
...
and the second element named ThreeDPathLength for the 3D length of the sortest path
